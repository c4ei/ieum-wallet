...
const english: Record<string, string> = {
  ...
  "지갑 복구 수단": "Wallet recovery",
  "지갑 백업": "Wallet backup",
  "접기": "Collapse",
  "펼치기": "Expand",
  "이 화면을 촬영하거나 온라인 메모·이메일에 저장하지 마세요. 이 값을 아는 사람은 지갑의 IEUM을 모두 옮길 수 있습니다.": "Do not photograph this screen or save it in online notes or email. Anyone who knows this value can move all IEUM in the wallet.",
  "이 지갑은 SEED 또는 개인키로 복구할 수 있습니다.": "This wallet can be recovered with its SEED phrase or private key.",
  "기존 금고에는 SEED가 저장되지 않아 다시 표시할 수 없습니다. 아래 개인키로 동일하게 복구할 수 있습니다.": "This existing vault did not store its SEED, so it cannot be shown again. The private key below provides the same recovery access.",
  "주변에 사람이 없고 안전한 오프라인 장소에 기록하겠습니다.": "I am alone and will record it in a secure offline place.",
  "복구 정보 숨기기": "Hide recovery information",
  "복구 정보 보기": "Show recovery information",
  "12단어 SEED": "12-word SEED",
  "개인키": "Private key",
  "SEED 복사": "Copy SEED",
